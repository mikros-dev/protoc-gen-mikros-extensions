...
type Addon interface {
	...
	GetTemplateImports(name types.Name, ctx interface{}, cfg *settings.Settings) []*Import
...
// OutboundExtension is an interface that allows the addon to insert custom code
...
// Import represents an import statement in a code template, which includes
// an optional alias and the package name.
type Import struct {
	Alias string
	Name  string
}
